...
class CartItemRepositoryTest {
    ...
    void findCartItemsByMemberIdAndStatusTest() {
        ...
        // when
        List<CartItem> cartItems = cartItemRepository.findCartItemsByMemberIdAndStatus(member.getMemberId().intValue(), statuses);
    ...
    void findByCart_CartIdAndProduct_ProductIdAndCartItemStatusTest() {
        // when
        Optional<CartItem> foundCartItem = cartItemRepository.findByCart_CartIdAndProduct_ProductIdAndCartItemStatus(
    ...
    void findByCart_CartIdAndProduct_ProductIdAndCartItemStatusInTest() {
        ...
        // when
        Optional<CartItem> foundCartItem = cartItemRepository.findByCart_CartIdAndProduct_ProductIdAndCartItemStatusIn(
