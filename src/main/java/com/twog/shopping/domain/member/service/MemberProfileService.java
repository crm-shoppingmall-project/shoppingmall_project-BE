...
public class MemberProfileService {
    ...
    public MemberProfileResponseDTO getMyPageInfo(String email) {
        ...
        // 회원 등급 설정
        if (member.getMemberGrade() != null && member.getMemberGrade().getGradeName() != null) {
            response.setGradeName(member.getMemberGrade().getGradeName().name());
        } else {
            response.setGradeName("BRONZE");
        }
    ...
    public MemberProfileResponseDTO updateMyPage(String email, MemberProfileRequestDTO dto) {
        ...
        member.getMemberProfile().updateMemberInfo(dto.getProfileAddress(), dto.getProfileDetailAddress(),
                dto.getProfilePreferred(), dto.getProfileInterests());
